...
function MainPlan({children,title } : { children? : React.ReactNode , title? : any }) {
  ...
  return (
    ...
    <div className='grid grid-cols-5   place-content-center mt-[28px]  place-items-stretch  pb-3 w-full  '>
